			...
			__all__: {
				...
				__init__: function (__all__) {
					...
					var Parser = __class__ ('Parser', [object], {
						...
						get process_table () {return __get__ (this, function (self, current_indent) {
							var table = null;
							var __left0__ = self.here ();
							var line_type = __left0__ [0];
							var indent = __left0__ [1];
						...
						get process_option () {return __get__ (this, function (self, current_indent) {
							self.skip_blank_lines ();
							var __left0__ = self.here ();
							var line_type = __left0__ [0];
							var indent = __left0__ [1];
						...
						get process_style_struct () {return __get__ (this, function (self, current_indent) {
							self.skip_blank_lines ();
