"use strict";
// Transcrypt'ed from Python, 2017-12-27 00:18:31
 ...
 */
	...
	__nest__(__all__, 'lawtext.parse', {
		__all__: {
			__inited__: false,
			__init__: function __init__(__all__) {
				var re = {};
				...
				var LawtextParseError = __class__('LawtextParseError', [Exception], {
					get __init__() {
						return __get__(this, function (self, message, lineno, lines) {
				...
				var LexerError = __class__('LexerError', [Exception], {
					get __init__() {
						return __get__(this, function (self, message, lineno) {
				...
				var LexerInternalError = __class__('LexerInternalError', [Exception], {
					get __init__() {
						return __get__(this, function (self, message) {
				...
				var detect_indent = function detect_indent(lines) {
					var indents = set();
				...
				var indent_level = function indent_level(indents, indent) {
				...
				var lex_line = function lex_line(line, indent) {
				...
				var lex_tcbody = function lex_tcbody(tcbody) {
					var attr = dict({});
					var body = tcbody;
					while (true) {
				...
				var skip_parenthesis = function skip_parenthesis(text, pos) {
				...
				var split_sentences = function split_sentences(text) {
					var sentences = list([]);
					var start_pos = 0;
					var pos = 0;
					while (pos < len(text)) {
				...
				var py_split = function py_split(text) {
					var split_text = list([]);
					var start_pos = 0;
					var pos = 0;
					while (pos < len(text)) {
				...
				var get_sentences = function get_sentences(text) {
					var els = list([]);
				...
				var Parser = __class__('Parser', [object], {
					get __init__() {
						return __get__(this, function (self, lexed_lines, lineno) {
					...
					get py_get() {
						return __get__(this, function (self, lineno) {
					...
					get process_article_group() {
						return __get__(this, function (self, parent_group_tag) {
					...
					get process_paragraph_items() {
						return __get__(this, function (self, current_indent, in_article) {
					...
					get process_paragraph_item() {
						return __get__(this, function (self, current_indent, first_paragraph_in_article) {
				...
				var parse_lawtext = function parse_lawtext(lawtext) {
