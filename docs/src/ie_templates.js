  ...
  (window.nunjucksPrecompiled = window.nunjucksPrecompiled || {})["lawtext.j2"] = function () {
    function root(env, context, frame, runtime, cb) {
      ...
      try {
        ...
        var macro_t_181 = runtime.makeMacro(["remarks"], [], function (l_remarks, kwargs) {
          var callerFrame = frame;
          frame = new runtime.Frame();
          kwargs = kwargs || {};
          if (kwargs.hasOwnProperty("caller")) {
        ...
        var macro_t_187 = runtime.makeMacro(["quote_struct"], [], function (l_quote_struct, kwargs) {
          var callerFrame = frame;
          frame = new runtime.Frame();
          kwargs = kwargs || {};
          if (kwargs.hasOwnProperty("caller")) {
        ...
        var macro_t_189 = runtime.makeMacro(["el"], [], function (l_el, kwargs) {
          var callerFrame = frame;
          frame = new runtime.Frame();
          kwargs = kwargs || {};
          if (kwargs.hasOwnProperty("caller")) {
        ...
        var macro_t_202 = runtime.makeMacro(["el"], [], function (l_el, kwargs) {
          var callerFrame = frame;
          frame = new runtime.Frame();
          kwargs = kwargs || {};
          if (kwargs.hasOwnProperty("caller")) {
